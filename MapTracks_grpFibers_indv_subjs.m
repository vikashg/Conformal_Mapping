...
roi
subj
trk_dir= strcat(output_dir_tracks, 'Segmented_tracks_coarse/');
trk_cell_file=strcat(trk_dir, roi, '.mat')
output_dir_map = strcat(map_tracks_dir, 'Segmented_tracks_coarse/') %changed output_dir to output_dir_map
...
combine_tracks_cell=track_cell;
