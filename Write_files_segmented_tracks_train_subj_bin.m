...
for i = 1:roi_num 
    ...
    track_file_dir=strcat(data_dir, 'NewResults/Mapped_tracks_binary/');
    Mapped_trk_file=strcat(track_file_dir, 'Mapped_tracks_', roi , extension, '.mat');

    if (exist(Mapped_trk_file) == 2)
    ...
    write_fiber_bundles_single_file_bin(output_dir, roi, Mapped_tracks, extension); 
